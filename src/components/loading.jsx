...
export default function Loading(props){
    ...
    useEffect(() =>{
        ...
        const timer = setTimeout(() => {
            pokeball.classList.add("poke-move")
